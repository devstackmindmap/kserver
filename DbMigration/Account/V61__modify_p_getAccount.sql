...
BEGIN
	...
	IF @isExists = 0 THEN
		INSERT INTO accounts(nickName, joinDateTime, currentSeason, socialAccount, email, countryCode) 
		VALUES($nickName, $joinDateTime, $serverSeason, $socialAccount, $email, $countryCode);
