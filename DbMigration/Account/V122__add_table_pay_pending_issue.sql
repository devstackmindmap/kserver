CREATE TABLE `pay_pending_issue` (
	...
	PRIMARY KEY (`seq`),
	UNIQUE INDEX `UX_pay_pending_issue_user_id_transactionId` (`userId`, `transactionId`),
	INDEX `IX_pay_pending_issue_user_id_is_pending` (`userId`, `is_pending`)
)
