...
BEGIN
	...
	ELSE
		...
		ELSE
			...
			INSERT INTO clans 
			(clanMasterUserId,clanName,clanSymbolId,clanPublicType,joinConditionRankPoint,rankPoint,memberCount,countryCode)
			VALUES 
			($userId,$clanName,$clanSymbolId,$clanPublicType,$joinConditionRankPoint,@currentSeasonRankPoint,1,$countryCode);
