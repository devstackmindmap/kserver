...
BEGIN
	...
	SELECT objectExp, objectLevel, coreExp, coreLevel, agencyExp, agencyLevel, userId, isActivated, activatedTime, nextInvasionTime, nextInvasionLevel, nextInvasionMonsterId, 
