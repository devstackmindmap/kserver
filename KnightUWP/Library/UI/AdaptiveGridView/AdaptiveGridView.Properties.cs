...
namespace Microsoft.Toolkit.Uwp.UI.Controls
{
    ...
    public partial class AdaptiveGridView
    {
        ...
        public static readonly DependencyProperty MaxItemWidthProperty =
            DependencyProperty.Register(nameof(MaxItemWidth), typeof(double), typeof(AdaptiveGridView), new PropertyMetadata(double.NaN, MaxItemWidthChanged));
        ...
        private static void MaxItemWidthChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var self = d as AdaptiveGridView;
            self.RecalculateLayout(self.ActualWidth);
        }
