...
def main():
	try: 
		...
		# print(userIds)
			...
			pipeline = {"fields.MaterialType" : '1' }
			...
			for result in results:
				...
				commander.execute('insert into kpi.refund_GD_log(userId, materialType, LogType, LogCategory, Count, total, datetime) values(%s,%s,%s,%s,%s,%s,%s)', userid, materialType, logtype, logCategory, count, total, datetimee )
