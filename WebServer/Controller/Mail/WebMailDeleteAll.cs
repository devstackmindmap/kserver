...
{
    public class WebMailDeleteAll : BaseController
    {
        public override async Task<BaseProtocol> DoPipeline(BaseProtocol requestInfo)
        {
            ...
            using (var accountDb = new DBContext("AccountDBSetting"))
            {
                ...
                {
                    ProtoMailDeleteAllResult readResult = new ProtoMailDeleteAllResult();
                    await accountDb.BeginTransactionCallback(async () =>
                    {
                        await userDb.BeginTransactionCallback(async () =>
                        {
                            ...
                            readResult = await mail.MailDeleteAll(req.MailIds);
                            return true;
                        });
                        return true;
                    });
