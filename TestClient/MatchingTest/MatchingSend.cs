...
namespace TestClient.MatchingTest
{
    public class MatchingSend
    {
        ...
        {
            MatchigServerConnector.Instance.Send(messageType, AkaSerializer.AkaSerializer<CommonProtocol.PubSub.ProtoOne2One>.
        ...
        {
            MatchigServerConnector.Instance.Send(messageType, AkaSerializer.AkaSerializer<CommonProtocol.PubSub.ProtoOne2N>.
        ...
        {
            MatchigServerConnector.Instance.Send(messageType, AkaSerializer.AkaSerializer<CommonProtocol.ProtoUserIdTargetId>.
        ...
        {
            MatchigServerConnector.Instance.Send(messageType, AkaSerializer.AkaSerializer<CommonProtocol.ProtoUserIdTargetIdClanId>.
        ...
        {
            MatchigServerConnector.Instance.Send(messageType, AkaSerializer.AkaSerializer<CommonProtocol.PubSub.ProtoClanChatting>.
        ...
        {
            MatchigServerConnector.Instance.Send(messageType, AkaSerializer.AkaSerializer<CommonProtocol.PubSub.ProtoClanId>.
        ...
        {
            MatchigServerConnector.Instance.Send(messageType, AkaSerializer.AkaSerializer<CommonProtocol.PubSub.ProtoClanJoin>.
