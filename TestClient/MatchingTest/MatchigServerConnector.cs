...
{
    public class MatchigServerConnector
    {
        private AsyncTcpSession _asyncTcpSession = new AsyncTcpSession();
        
        public MatchigServerConnector()
        {

        }

        private static MatchigServerConnector _instance = null;
        public static MatchigServerConnector Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new MatchigServerConnector();
                }
                return _instance;
            }
        }
        ...
        private void AsyncTcpSession_DataReceived(object sender, DataEventArgs e)
        {
            ...
            while (offset < e.Length)
            {
                ...
                MatchingReceive.Run(proto, msgType);
            }
        }
